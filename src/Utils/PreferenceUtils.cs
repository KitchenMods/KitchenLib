...
namespace KitchenLib.Utils
{
    ...
    public static class PreferenceUtils {
	    ...
	    public static T Register<T>(string modID, string key, string name) where T : BasePreference, new() {
		    BaseMod.InternalLogger.LogInfo("Registering Preference: " + modID + ":" + key);
			...
			{
				BaseMod.InternalLogger.LogWarning("[WARN] " + modID + ":" + key + " already exists! Has another mod already loaded it?");
			}
			else
			{
