...
namespace KitchenLib.Customs
{
	public class CSimpleFlat : CustomMaterial, IMaterialEditor
	{
		...
		public float _OverlayColourA = 0.0f;
		[JsonIgnore]
		...
		public override void Deserialise()
		{
			...
			_OverlayColour = new Vector4(_OverlayColourX, _OverlayColourY, _OverlayColourZ, _OverlayColourA);
		...
		static IMColorPicker secondaryColorPicker;
		...
		public void GUI(Material material)
		{
			...
			if(secondaryColorPicker == null)
				secondaryColorPicker = new IMColorPicker();
			
			material.SetColor("_Color0", DrawColorModule(new Rect(2, 2, 146, 186), secondaryColorPicker, "Primary Color", material.GetVector("_Color0")));
			material.SetColor("_Colour2", DrawColorModule(new Rect(152, 2, 146, 186), mainColorPicker, "Secondary Color", material.GetVector("_Colour2")));
			material.SetColor("_OverlayColour", DrawColorModule(new Rect(302, 2, 146, 186), overlayColorPicker, "Overlay Color", material.GetVector("_OverlayColour")));
		...
		public string Export(Material material)
		{
			...
			result._Highlight = material.GetInt("_Highlight") == 0;
			...
			result._OverlayColourX = material.GetColor("_OverlayColour").r;
			result._OverlayColourY = material.GetColor("_OverlayColour").g;
			result._OverlayColourZ = material.GetColor("_OverlayColour").b;
			result._OverlayColourA = material.GetColor("_OverlayColour").a;
